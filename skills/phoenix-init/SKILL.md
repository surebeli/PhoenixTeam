...
Output the following block **verbatim**, then **stop and wait** for the user to reply:
...
After the user replies with their code, continue. Output the following block **verbatim**, then **stop and wait**:
